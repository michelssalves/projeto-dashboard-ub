...
class EventoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Disparar o job para buscar os eventos
        BuscarEventosJob::dispatch($dataInicio, $dataFinal, $apiUrl, $apiToken, $eventoMotivoSelecionado);

        return view('eventos.index')->with('mensagem', 'Os eventos estão sendo processados, por favor aguarde...');
    }
}
